...
test('CriarItemSuporte', async ({ page }) => {
    ...
    await page.waitForTimeout(3000);
    await page.fill('[id="Respons_x00e1_vel_7e214bdc-6cac-4eb8-a55b-30481ded226d_$ClientPeoplePicker_EditorInput"]', 'Sara Silva');
    await page.waitForTimeout(2000);
    await page.keyboard.press('Enter');
    await page.waitForTimeout(2000);
    await page.keyboard.press('Enter');
    await page.waitForTimeout(2000);
    await page.fill('[id="Analysis_x0020_Person_01d8896a-218d-4303-982c-f2213057623e_$ClientPeoplePicker_EditorInput"]', 'Sara Silva');
    await page.waitForTimeout(2000);
    await page.keyboard.press('Enter');
    await page.waitForTimeout(2000);
    await page.keyboard.press('Enter');
    await page.waitForTimeout(2000);
    await page.fill('[id="AssignedTo_53101f38-dd2e-458c-b245-0c236cc13d1a_$ClientPeoplePicker_EditorInput"]', 'Sara Silva');
    await page.waitForTimeout(2000);
    await page.keyboard.press('Enter');
    await page.waitForTimeout(2000);
    await page.keyboard.press('Enter');
    await page.waitForTimeout(2000);
    await page.fill('[id="Validation_x0020_Person_db3b4462-feb6-4d75-8302-0f30c9c37cfe_$ClientPeoplePicker_EditorInput"]', 'Sara Silva');
    await page.waitForTimeout(2000);
    await page.keyboard.press('Enter');
    await page.waitForTimeout(2000);
    await page.keyboard.press('Enter');
